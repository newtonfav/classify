...
export default async function InventoryItems() {
  ...
  return (
    <nav className="border-r midPhone:border-none border-primary-900 p-5 h-full flex flex-col phone:px-2">
      ...
      <div className="flex-grow">
        <div className="h-[25rem] midPhone:h-[5rem] overflow-y-auto space-y-4 mr-5 midPhone:mr-0">
          {items.map((item) => (
            <ItemCards
              name={item.name}
