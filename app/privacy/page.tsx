...
export default function page() {
  return (
    <div>
      ...
      <p>
        The Application collects information when you use it. This information
        may include information such as
      </p>
      <ul>
        <li>Your email address</li>
        <li>Your public profile image attached to your email address</li>
        <li>The name associated to your email address.</li>
      </ul>
      <p></p>
      <br />
      <p>
        The Application does not gather your precise information about the
      ...
      <p>
        ...
        gh.oghene@gmail.com. The information that the Service Provider request
      ...
      <div>
        ...
        <ul>
          ...
          <li>
            <a
              href="https://https://supabase.com/privacy"
              target="_blank"
              rel="noopener noreferrer"
            >
              Supabase Services
      ...
      <p>
        ...
        Application, please contact them at gh.oghene@gmail.com and they will
      ...
      <div>
        ...
        <p>
          ...
          the Service Provider (gh.oghene@gmail.com) so that they will be able
      ...
      <br />
      <p>This privacy policy is effective as of 2024-08-04</p>
      <br />
